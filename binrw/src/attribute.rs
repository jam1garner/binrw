...
//! | [`temp`](#temp) | field | Uses a field as a temporary variable. Only usable with the [`binread`] attribute macro.
...
//! # Temp
//!
//! **This directive can only be used with [`binread`]. It will not work
//! with `#[derive(BinRead)]`.**
//!
