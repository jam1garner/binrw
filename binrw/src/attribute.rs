...
//! | [`temp`](#temp) | field | Uses a field as a temporary variable. Only usable with the [`binread`](macro@binread) attribute macro.
...
//! # Temp
//!
//! **This directive can only be used with [`binread`](macro@binread). It will not work
//! with `#[derive(BinRead)]`.**
//!
...
//! definition generated by [`binread`](macro@binread):
//!
//! ```text
//! #[br(temp)]
//! ```
